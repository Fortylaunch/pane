...
export const defaultTheme: PaneTheme = {
  ...
  tokens: {
    ...
    typography: {
      ...
      scale: {
        xs:   { size: '0.625rem',  lineHeight: '0.875rem', weight: 400 },
        sm:   { size: '0.6875rem', lineHeight: '1rem',     weight: 400 },
        md:   { size: '0.75rem',   lineHeight: '1.0625rem', weight: 400 },
        lg:   { size: '0.8125rem', lineHeight: '1.125rem', weight: 500 },
        xl:   { size: '0.875rem',  lineHeight: '1.25rem',  weight: 600 },
        '2xl': { size: '1.125rem', lineHeight: '1.5rem',   weight: 700 },
      },
    },
    spacing: {
      unit: '0.25rem',
