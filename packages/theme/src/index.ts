...
export const defaultTheme: PaneTheme = {
  ...
  tokens: {
    ...
    typography: {
      ...
      scale: {
        xs:   { size: '0.6875rem', lineHeight: '0.875rem', weight: 400 },
        sm:   { size: '0.8125rem', lineHeight: '1.125rem', weight: 400 },
        md:   { size: '0.875rem',  lineHeight: '1.25rem',  weight: 400 },
        lg:   { size: '1rem',      lineHeight: '1.375rem', weight: 500 },
        xl:   { size: '1.25rem',   lineHeight: '1.625rem', weight: 600 },
        '2xl': { size: '1.5rem',   lineHeight: '1.875rem', weight: 700 },
      },
    },
    spacing: {
      unit: '0.25rem',
